...
describe('SuggestionsComponent', () => {
  ...
  it('should call suggestionService.fetchAllNotifications()', () => {
    spyOn(service, 'fetchAllSuggestions').and.callThrough();
    component.ngOnInit();
    expect(service.fetchAllSuggestions).toHaveBeenCalled();
  });
});
